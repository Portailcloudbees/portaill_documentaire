            ...
            <!-- table de company -->
               ...
               <div class="portlet box blue">
                  ...
                  <div class="portlet-body">
                     <div class="table-toolbar">
                        <div class="btn-group">
                           <button <%if (addClient){ out.println("id='sample_editable_1_new'");} %> class="btn green">
                           Add New <i class="icon-plus"></i>
                           </button>
                        </div>
                        <div class="btn-group pull-right">
                     ...
                     <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                        ...
                        %>
                           <tr >
							  ...
							  <td><%if (updateClient){out.println("<a class='edit' href='javascript:;'>");} %>Edit</a></td>
                              <td><%if (deleteClient){out.println("<a class='delete' href='javascript:;'>");} %>Delete</a></td>
                           </tr>
