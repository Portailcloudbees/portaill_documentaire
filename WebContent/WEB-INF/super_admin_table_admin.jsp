...
<body class="page-header-fixed">
               ...
               <div class="portlet box blue">
                  ...
                  <div class="portlet-body">
                     <div class="table-toolbar">
                        <div class="btn-group">
                           <button id="sample_editable_admin_new" class="btn green">
                     ...
                     <table class="table table-striped table-hover table-bordered" id="sample_editable_admin">
                        <thead>
                           <tr>
                              <th>Email Admin</th>
                              <th>Nom Admin</th>
                        ...
                        ArrayList<administrateur> liste_admin = (ArrayList<administrateur>) request.getAttribute("list_de_admin");
                        for ( i=0; i<liste_admin.size(); i++) { 
                            	
                        %>
                           <tr >
                              <td><%= liste_admin.get(i).getEmail_admin() %></td>
                              <td><%= liste_admin.get(i).getNom_admin() %></td>
                              <td><%= liste_admin.get(i).getPrenom_admin() %></td>
                              <td ><%= liste_admin.get(i).getMot_de_passe() %></td>
							  <td><a href="list_update_priv_admin?admin=<% out.println(liste_admin.get(i).getEmail_admin()); %>">Privilege</a></td>
   ...
   <script src="assets/scripts/table-editable-admins.js"></script> 
 
   <script>
      jQuery(document).ready(function() {       
         App.init();
         TableEditableAdmin.init();
