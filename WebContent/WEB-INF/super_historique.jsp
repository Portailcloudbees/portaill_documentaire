                  ...
                  <div class="portlet-body">
                     ...
                     <table class="table table-striped table-hover table-bordered" id="sample_editable_admin">
                        ...
                        <tbody>
                           ...
                           ArrayList<historique> liste_admin = (ArrayList<historique>) request.getAttribute("list_de_administrateur");
                           for ( i=0; i<liste_admin.size(); i++) { 
                               	
                           %>
                           <tr >
                               <td><%= liste_admin.get(i).getId() %></td>
                         	  <td><%= liste_admin.get(i).getDate() %></td>
                              <td><%= liste_admin.get(i).getIpAdresse() %></td>
                              <td><%= liste_admin.get(i).getEmail() %></td>
                              <td><%= liste_admin.get(i).getTache() %></td>                            
