...
<body class="page-header-fixed">
      ...
      <div class="page-sidebar navbar-collapse collapse">
         ...
         <li>
            ...
            <ul class="sub-menu">
                  <li>
                        <% if (viewHistorique){
                   out.println("<a href='list_getlast_client_historique'>"+
                          " View Historique"+ 
                           "<span class='arrow'></span>"+
                           "</a>");
                   }else{
         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <ul class="page-breadcrumb breadcrumb">
				  ...
				  <i class="icon-angle-right"></i>
				  <li><a href="#">View File Processed</a></li>
                  <li class="pull-right">
  ...
  <div class="portlet box blue">
                  <div class="portlet-title">
                     <div class="caption"><i class="icon-edit"></i>File Processed</div>
                     <div class="tools">
                     ...
                     <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                        ...
                        <tbody>
                           <tr >
							  ...
							  <td><a class="edit" href="javascript:;">Send SMS</a></td>
                              <td><a class="delete" href="javascript:;">Send Email</a></td>
                           </tr>
                        </tbody>
                     </table>
                  </div>
