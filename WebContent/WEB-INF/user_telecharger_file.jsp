                        ...
                        %>
                           <tr>
							 ...
							 %>
                              ...
                              <td> <% if (sendEmail){
						                   out.println("<a href='#email' data-toggle='modal' >E-mail</a>");
						                   	}else{
                 						out.println("E-mail");
                 				 }%></td>
                              ...
                              <td> <% if (sendSms){
						                   out.println("<a href='#sms' data-toggle='modal' >Send Sms</a>");
						                   	}else{
                 						out.println("Send Sms");
                 				 }%></td>
                              <!--modal begin-->
                             ...
                             <!--modal end-->
                              ...
                              <td> <% if (deleteFile){
						                   out.println("<a class='delete' href='javascript:;'>Delete</a>");
						                   	}else{
                 						out.println("Delete");
                 				 }%></td>
