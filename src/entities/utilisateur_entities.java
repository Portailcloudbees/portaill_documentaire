...
public class utilisateur_entities {
	...
	public int getDate_ajout_ut() {
		return date_ajout_ut;
	}
	public void setDate_ajout_ut(int date_ajout_ut) {
		this.date_ajout_ut = date_ajout_ut;
	}
